...
hash_table.set_val('mengqianshasha@163.com', 'some value')
hash_table.set_val('mengqianshasha@163.com', 'I love python')


print(hash_table.delete('mengqianshasha@163.com'))